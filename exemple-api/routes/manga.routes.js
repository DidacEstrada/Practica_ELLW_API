...
const { getManga, getMangasByAutor, getMangasByGenere, getAllMangas } = require('../controllers/get-manga.controller');
...
router.get('/titol/:titol', checkSecretMiddleware, getManga);
